...
public class ActionEngine extends TestEngine {
	...
	public   String TESTDATAWORKBOOK = "TestData\\"+configProps.getProperty("TestDataWorkBook").toString(); // Client module input sheet file location
	public   String TESTDATAWORKBOOKDMSE = "TestData\\"+configProps.getProperty("TestDataWorkBookDMSE").toString(); // Client module input sheet file location
	public   String TestDataWorkBookE1 = "TestData\\"+configProps.getProperty("TestDataWorkBookE1").toString();
	public   String TestDataWorkBizTalktoIIB = "TestData\\"+configProps.getProperty("TestDataWorkBizTalktoIIB").toString();
	public   String TestDataWorkE1toSFDC = "TestData\\"+configProps.getProperty("TestDataWorkE1toSFDC").toString();
	public   String TestDataWorkONDemand = "TestData\\"+configProps.getProperty("TestDataWorkONDemand").toString();
