...
public class HtmlReportSupport {
	...
	public String strPath = System.getProperty("user.dir");
	...
	public static void createHtmlSummaryReport(String browser,
		...
		try {
			...
			writer.write("<img align ='left' src= G:/Selenium_Java/Automation_Hybrid/Logos/giggle.png></img>");
			writer.write("</th>");
			writer.write("<th class = 'Logos' colspan='2' > ");
			writer.write("<img align ='right' src= G:/Selenium_Java/Automation_Hybrid/Logos/Cognizant.png></img>");
			writer.write("</th> ");
			writer.write("</tr> ");
